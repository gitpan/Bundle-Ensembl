# This Makefile is for the Bundle::Math extension to perl.
#
...
DISTNAME = Bundle-Math
DISTVNAME = Bundle-Math-1.02
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  Math.pm $(INST_MAN3DIR)/Bundle::Math.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:         Bundle-Math' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:      1.02' >> META_new.yml
	$(NOECHO) $(ECHO) 'version_from: Math.pm' >> META_new.yml
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  Math.pm $(INST_LIB)/Bundle/Math.pm 
